...
-- beeline -u jdbc:hive2:// -f /home/julio/procesos/Poblando_Capa_Landing.sql --hiveconf "PARAM_USERNAME=juan" --hiveconf "ENV=DEV" 

/*
hdfs dfs -mkdir -p /user/julio/datalake/schema/dev_LANDING
hdfs dfs -put /home/julio/schema/*.avsc  /user/julio/datalake/schema/dev_LANDING/
*/
-- -------------------------------------------------------------------------------------------------------
-- 
